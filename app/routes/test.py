...
from app.custom_classes.finbert import model_loader, predictor_all, predictor_fixed
...
class Movies(object):
    ...
    def get_result(self, sentences: str = Query(...)):
        ...
        from app.main import pipe_line_fixed, pipe_line_all
        if pipe_line_fixed is None:
        ...
        results = predictor_fixed(pipe_line_fixed, sentences)
        neutral_flag = True
        negative_count = 0
        negative_prob = 0
        positive_count = 0
        ...
        # print(results)
        # return results
    # @router.get("/predict/averaged")
    # def get_result_averaged(self, sentences: str = Query(...)):
    #     print(sentences)
    #     #
    #     # Object interface
    #     # #
    ...
    #     nltk.download('punkt')
    #     sentences= sent_tokenize(sentences)
    #     results = predictor_all(pipe_line_all, sentences)
    #     return results
    #     # neutral_flag = True
    #     # negative_count = 0
    #     # negative_prob = 0
